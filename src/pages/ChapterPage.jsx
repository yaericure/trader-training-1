    ...
    <div className="flex min-w-0 flex-1">
      <main className="min-w-0 flex-1 px-5 py-8 sm:px-8 lg:px-12">
        ...
        <div className="mb-8">
          ...
          <div className="mt-4 h-1.5 w-36 rounded-full bg-gradient-to-r from-red-600 via-red-400 to-red-200 dark:from-red-400 dark:via-red-500 dark:to-red-900" />
        </div>
        ...
        <footer className="mt-10 pb-4 text-xs leading-relaxed text-zinc-400">
          本站為《頂尖操盤手的養成計畫1:建立你的獲利模型》(約翰・派伯 John Piper 著,樂金文化出版)的教學導讀筆記,內容為重點整理與延伸解說,並非原書全文。完整內容請支持正版書籍。
        </footer>
      </main>
